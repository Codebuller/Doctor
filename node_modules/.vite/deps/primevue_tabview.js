...
var _hoisted_2 = createBaseVNode("span", { class: "pi pi-chevron-left" }, null, -1);
var _hoisted_3 = [
  _hoisted_2
];
var _hoisted_4 = {
...
var _hoisted_5 = ["onClick", "onKeydown", "tabindex", "aria-selected"];
var _hoisted_6 = {
  key: 0,
...
var _hoisted_8 = createBaseVNode("span", { class: "pi pi-chevron-right" }, null, -1);
var _hoisted_9 = [
  _hoisted_8
];
var _hoisted_10 = { class: "p-tabview-panels" };
var _hoisted_11 = {
  key: 0,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", _hoisted_1, [
      $props.scrollable && !$data.backwardIsDisabled ? withDirectives((openBlock(), createElementBlock("button", {
        key: 0,
        ref: "prevBtn",
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.tabs, (tab, i) => {
            return openBlock(), createElementBlock("li", {
              ...
              withDirectives((openBlock(), createElementBlock("a", {
                ...
                tab.props && tab.props.header ? (openBlock(), createElementBlock("span", _hoisted_6, toDisplayString(tab.props.header), 1)) : createCommentVNode("", true),
      ...
      $props.scrollable && !$data.forwardIsDisabled ? withDirectives((openBlock(), createElementBlock("button", {
        key: 1,
        ref: "nextBtn",
    ...
    createBaseVNode("div", _hoisted_10, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($options.tabs, (tab, i) => {
        return openBlock(), createElementBlock(Fragment, {
          ...
          ($props.lazy ? $data.d_activeIndex === i : true) ? withDirectives((openBlock(), createElementBlock("div", _hoisted_11, [
