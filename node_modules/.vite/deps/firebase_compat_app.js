...
var FirebaseAppImpl2 = class {
   ...
   * @internal
   */
  _getService(name4, instanceIdentifier = DEFAULT_ENTRY_NAME2) {
    var _a;
    this._delegate.checkDestroyed();
   ...
   * @internal
   */
  _removeServiceInstance(name4, instanceIdentifier = DEFAULT_ENTRY_NAME2) {
...
function createFirebaseNamespaceCore(firebaseAppImpl) {
  ...
  function app(name4) {
    ...
    if (!contains(apps, name4)) {
      throw ERROR_FACTORY2.create("no-app", { appName: name4 });
    }
    return apps[name4];
  }
