...
var _hoisted_10 = { class: "p-dropdown-item-group" };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    $props.editable ? (openBlock(), createElementBlock("input", {
      key: 0,
      type: "text",
    ...
    !$props.editable ? (openBlock(), createElementBlock("span", {
      key: 1,
    ...
    $props.showClear && $props.modelValue != null ? (openBlock(), createElementBlock("i", {
      key: 2,
                      ...
                      !$props.optionGroupLabel ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(items, (option, i) => {
                        ...
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList($options.getOptionGroupChildren(optionGroup), (option, i2) => {
                            return withDirectives((openBlock(), createElementBlock("li", {
                              class: normalizeClass(["p-dropdown-item", { "p-highlight": $options.isSelected(option), "p-disabled": $options.isOptionDisabled(option) }]),
                              key: $options.getOptionRenderKey(option, i2),
                              onClick: ($event) => $options.onOptionSelect($event, option),
                              role: "option",
                              "aria-label": $options.getOptionLabel(option),
                              "aria-selected": $options.isSelected(option)
...
//# sourceMappingURL=chunk-7O4BUII6.js.map
