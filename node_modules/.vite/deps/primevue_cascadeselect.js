...
var _hoisted_2$1 = ["onClick", "onKeydown"];
var _hoisted_3$1 = {
  key: 1,
      ...
      return openBlock(), createElementBlock("li", {
        ...
        withDirectives((openBlock(), createElementBlock("div", {
          ...
          $props.templates["option"] ? (openBlock(), createBlock(resolveDynamicComponent($props.templates["option"]), {
            key: 0,
            option
          }, null, 8, ["option"])) : (openBlock(), createElementBlock("span", _hoisted_3$1, toDisplayString($options.getOptionLabelToRender(option)), 1)),
          $options.isOptionGroup(option) ? (openBlock(), createElementBlock("span", _hoisted_4$1)) : createCommentVNode("", true)
        ], 40, _hoisted_2$1)), [
          [_directive_ripple]
        ]),
        $options.isOptionGroup(option) && $options.isOptionActive(option) ? (openBlock(), createBlock(_component_CascadeSelectSub, {
          key: 0,
        ...
        }, null, 8, ["selectionPath", "options", "optionLabel", "optionValue", "level", "onOptionSelect", "onOptiongroupSelect", "optionGroupLabel", "optionGroupChildren", "parentActive", "dirty", "templates"])) : createCommentVNode("", true)
      ], 2);
    }), 128))
  ]);
}
...
var _hoisted_4 = { class: "p-cascadeselect-items-wrapper" };
