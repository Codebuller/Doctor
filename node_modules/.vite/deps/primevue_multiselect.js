import {
  FilterService
} from "./chunk-DZBPSIDI.js";
import {
  script
} from "./chunk-AGPVGSU5.js";
import {
  OverlayEventBus
...
var _hoisted_8 = ["aria-checked"];
var _hoisted_9 = { class: "p-hidden-accessible" };
var _hoisted_10 = ["aria-checked"];
var _hoisted_11 = {
  key: 1,
  class: "p-multiselect-filter-container"
};
var _hoisted_12 = ["placeholder"];
var _hoisted_13 = createBaseVNode("span", { class: "p-multiselect-filter-icon pi pi-search" }, null, -1);
var _hoisted_14 = createBaseVNode("span", { class: "p-multiselect-close-icon pi pi-times" }, null, -1);
var _hoisted_15 = [
  _hoisted_14
];
var _hoisted_16 = ["aria-selected", "onClick", "onKeydown", "tabindex", "aria-label"];
var _hoisted_17 = { class: "p-checkbox p-component" };
var _hoisted_18 = { class: "p-multiselect-item-group" };
var _hoisted_19 = ["aria-selected", "onClick", "onKeydown", "tabindex", "aria-label"];
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", {
              ...
              $props.showToggleAll && $props.selectionLimit == null || $props.filter ? (openBlock(), createElementBlock("div", _hoisted_7, [
                ...
                $props.filter ? (openBlock(), createElementBlock("div", _hoisted_11, [
                ...
                createVNode(_component_VirtualScroller, mergeProps({ ref: $options.virtualScrollerRef }, $props.virtualScrollerOptions, {
                  ...
                  content: withCtx(({ styleClass, contentRef, items, getItemOptions, contentStyle }) => [
                    createBaseVNode("ul", {
                      ...
                      !$props.optionGroupLabel ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(items, (option, i) => {
                      ...
                      }), 128)) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(items, (optionGroup, i) => {
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList($options.getOptionGroupChildren(optionGroup), (option, i2) => {
                            return withDirectives((openBlock(), createElementBlock("li", {
                              class: normalizeClass(["p-multiselect-item", { "p-highlight": $options.isSelected(option), "p-disabled": $options.isOptionDisabled(option) }]),
                              role: "option",
                              "aria-selected": $options.isSelected(option),
