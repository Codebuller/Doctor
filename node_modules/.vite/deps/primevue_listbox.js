...
var _hoisted_1 = { class: "p-listbox p-component" };
var _hoisted_2 = {
  key: 0,
  class: "p-listbox-header"
};
var _hoisted_3 = { class: "p-listbox-filter-container" };
var _hoisted_4 = ["placeholder"];
var _hoisted_5 = createBaseVNode("span", { class: "p-listbox-filter-icon pi pi-search" }, null, -1);
var _hoisted_6 = ["tabindex", "onClick", "onKeydown", "aria-label", "aria-selected"];
var _hoisted_7 = { class: "p-listbox-item-group" };
var _hoisted_8 = ["tabindex", "onClick", "onKeydown", "aria-label", "aria-selected"];
var _hoisted_9 = {
  key: 2,
      ...
      createVNode(_component_VirtualScroller, mergeProps({ ref: $options.virtualScrollerRef }, $props.virtualScrollerOptions, {
        ...
        content: withCtx(({ styleClass, contentRef, items, getItemOptions, contentStyle }) => [
          createBaseVNode("ul", {
            ...
            $data.filterValue && (!items || items && items.length === 0) ? (openBlock(), createElementBlock("li", _hoisted_9, [
              renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                createTextVNode(toDisplayString($options.emptyFilterMessageText), 1)
              ])
            ])) : !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("li", _hoisted_10, [
