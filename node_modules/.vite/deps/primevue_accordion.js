...
var _hoisted_2 = ["onClick", "onKeydown", "tabindex", "aria-expanded", "id", "aria-controls"];
var _hoisted_3 = {
  key: 0,
  class: "p-accordion-header-text"
};
var _hoisted_4 = ["id", "aria-labelledby"];
var _hoisted_5 = { class: "p-accordion-content" };
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("a", {
            ...
            tab.props && tab.props.header ? (openBlock(), createElementBlock("span", _hoisted_3, toDisplayString(tab.props.header), 1)) : createCommentVNode("", true),
        ...
        createVNode(Transition, { name: "p-toggleable-content" }, {
          default: withCtx(() => [
            ($props.lazy ? $options.isTabActive(i) : true) ? withDirectives((openBlock(), createElementBlock("div", {
              key: 0,
