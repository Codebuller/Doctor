...
var _hoisted_2 = ["value", "aria-controls"];
var _hoisted_3 = { class: "p-autocomplete-token-label" };
var _hoisted_4 = ["onClick"];
var _hoisted_5 = { class: "p-autocomplete-input-token" };
var _hoisted_6 = ["aria-controls"];
var _hoisted_7 = ["id"];
var _hoisted_8 = ["onClick", "data-index"];
var _hoisted_9 = { class: "p-autocomplete-item-group" };
var _hoisted_10 = ["onClick", "data-group", "data-index"];
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($props.modelValue, (item, i) => {
        return openBlock(), createElementBlock("li", {
          ...
          renderSlot(_ctx.$slots, "chip", { value: item }, () => [
            createBaseVNode("span", _hoisted_3, toDisplayString($options.getItemContent(item)), 1)
          ]),
              ...
              createVNode(_component_VirtualScroller, mergeProps({ ref: $options.virtualScrollerRef }, $props.virtualScrollerOptions, {
                ...
                content: withCtx(({ styleClass, contentRef, items, getItemOptions, contentStyle }) => [
                  createBaseVNode("ul", {
                    ...
                    !$props.optionGroupLabel ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(items, (item, i) => {
